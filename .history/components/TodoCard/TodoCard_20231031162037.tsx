    ...
    >
      <div className="flex justify-between items-center p-5">
        ...
        <button onClick={() => deleteTask(index, todo, id)}>
          <XCircleIcon className="ml-5 h-8 w-8 text-red-300 hover:text-red-500" />
        
        </button>
        <button>  <PencilSquareIcon className="ml-5 h-8 w-8 text-purple-300 hover:text-purple-600" /></button>
      </div>
